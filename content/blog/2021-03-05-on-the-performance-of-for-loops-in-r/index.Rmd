...
In this case, the three implementations have a similar performance. Functions of the `apply` family seem to be marginally more efficient than the `for` loop. 
