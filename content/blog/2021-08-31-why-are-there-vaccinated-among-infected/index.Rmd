...
In the moment of the COVID-19 pandemic we are living, we sometimes hear concerns about the efficacy of vaccines. One of the reasons argued against vaccination is that among infected with COVID-19 there is more vaccinated than unvaccinated people. The aim of this post is to show that **as the number of people receiving effective vaccines increases, the proportion of vaccinated among infected people will also increase.**

Let's suppose that we have a population $P$ of one million people in a region where a fraction $i$ of 10% is infected with COVID-19 when not vaccinated. This means that with **no vaccination** we have **100,000** people infected.

Let's introduce a vaccine with an [efficacy](https://www.who.int/news-room/feature-stories/detail/vaccine-efficacy-effectiveness-and-protection) $e$ of 80%. An efficacy of 80% means that 80% of the people that would be infected without the vaccine will get rid of the disease if vaccinated. So, if only 20% out of 10% will be infected, the vaccine reduces the infection rate from 10% to 2%.

When we have the **30%** of the population vaccinated, we can expect 70,000 (10% out of 700,000) of infected among the unvaccinated, but among the 300,000 vaccinated, we will have only 6,000 people infected (the 2% of 300,000). So we have **70,000 + 6,000 = 76,000** people infected.

What happens when the vaccination rate raises to **70%**? We can expect 30,000 infected among the 300,000 unvaccinated, but only 14,000 out of the 700,000 vaccinated. So we have now **30,000 + 14,000 = 44,000** people infected. The proportion of vaccinated among infected raises to 31.8%.
...
In the plot below I am presenting how is evolving the number of vaccinated and unvaccinated infected as the coverage of the vaccine increases.
...
vax_sample %>%
  ...
  theme_classic() +
  labs(title = "Evolution of infected with vaccination", x = "vaccination rate", y = "infected") +
...
While an unvaccinated individual has a probability of $i$ of being infected, a vaccinated individual will have a lower probability of infection $\left(1-e\right)i$. So, the number of **infected, vaccinated** people is:
...
Note that if $v=0$ the ratio is equal to zero, and if $v=1$ is equal to one. This makes sense, as in the later case there are no unvaccinated people left.

Let's examine the ratio of vaccinated, infected people for the [Pfizer and AZ vaccines with the delta variant](https://www.nejm.org/doi/full/10.1056/NEJMoa210889) (88% and 67% respectively), together with an hypothetical vaccine of efficacy of 30% as vaccination rate grows.
...
The good news is that as we increase the vaccination rate, the value of $I_n$ will decrease:
...
Although the efficacy of vaccines might have been reduced because of this delta variant, the dire consequences of this variant for the unvaccinated make getting your vaccine the wisest thing to do.
